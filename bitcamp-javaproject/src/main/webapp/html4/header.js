...
$.get("/bitcamp-javaproject/html4/header.html", (data) => {
	$("#header").html(data);
	loadLoginUser();
});
	...
	$.getJSON("/bitcamp-javaproject/json/auth/loginUser", (data) => {
			...
			$("#logoutBtn").click((e) => {
				...
				$.get("/bitcamp-javaproject/json/auth/logout", () => {
					location.href = "/bitcamp-javaproject/html4/auth/login.html";
				});
			});
		}).fail(() => {
		location.href="/bitcamp-javaproject/htm4/auth/login.html";
	});
}
